...
function solveCollisions(balls, width, height) {
...
function takeTimestep(balls, dt, config) {
    integrate(balls, dt, config.G);
    solveCollisions(balls, config.width, config.height);
}
